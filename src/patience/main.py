...
def main():
    ...
    parser.add_option("-s", "--seq", help="Force sequential", default=False, action="store_true")

    parser.add_option("-v", "--verbose", help="Write status messages", default=False, action="store_true")

    parser.add_option(
        "-V", help="Show git operations", dest="show_operations", default=False, action="store_true"
    )

    parser.add_option(
        "-O", help="Show stdout/stderr of operations", dest="show_stdout", default=False, action="store_true"
    )

    parser.add_option("--yaml", help="Write YAML output", default=False, action="store_true")
